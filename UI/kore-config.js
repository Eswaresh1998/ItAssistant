(function (KoreSDK) {
  ...
  let JWT_URL =
    "https://searchassistbotqa.mangobeach-6a361337.eastus2.azurecontainerapps.io/api/users/sts";
  // botOptions.JWTUrl = "http://localhost:3000/api/users/sts";
  botOptions.JWTUrl = JWT_URL;
  botOptions.userIdentity = koreGenerateUUID(); // Provide users email id here

  botOptions.botInfo = {
    name: "IT Assistant",
    _id: "st-b1ad787b-7c8d-5576-a8c0-3c15b1f540a6",
  ...
  /* 
    ...
    **/
  botOptions.clientId = "cs-8d22867f-7954-5cf3-aa64-5b4052543667";
  botOptions.clientSecret = "UyP9AMjmoqzDKKVeznBtbAsbZkW1M4VgkN4KckHy1hk=";
